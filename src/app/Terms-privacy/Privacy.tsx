export const Privacy = () => {
  return (
    <div className="max-w-[750px] m-auto mt-10 p-4">
      <h1 className="text-5xl font-bold mb-10 mt-10">Privacy Policy</h1>
      ...
      <p className="mb-4">
        ...
        analysis, and email delivery. We may also share your information to
        comply with legal obligations, protect our rights, and with your
        consent.
      </p>
